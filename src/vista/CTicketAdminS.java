...
import controlador.ControladorTicketAdminS;
 ...
 *
 */
public class CTicketAdminS extends javax.swing.JFrame {

    /**
     * Constructor de la ventana de tickets de administrador de sistema
     */
    public CTicketAdminS(int id, int idCaso, int comprobar, Modelo modelo, HiloRecepcion hilo) {

        this.idAdmin = id;
        this.idCaso = idCaso;
        this.comprobar = comprobar;
        this.hilo = hilo; //Hilo que gestiona la recepción de tickets de administradores de reserva
        this.modelo = modelo;
        initComponents();
    ...
    private void initComponents() {
        ...
        ControladorTicketAdminS controlador = new ControladorTicketAdminS(this, modelo, hilo, idAdmin);
    ...
    public HiloRecepcion getHilo() {
        return hilo;
    }

    public void setHilo(HiloRecepcion hilo) {
        this.hilo = hilo;
    }
