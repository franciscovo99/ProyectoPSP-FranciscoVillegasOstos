            ...
            try {
                ...
                if (o.getClass().equals(TicketVO.class)) { //Si el objeto recibido es de clase TicketVO:
                    ...
                    try {
                        ...
                        System.out.println("Id de ticket: " + ticket.getId());
                        System.out.println("Id del caso: " + ticket.getIdCaso());
                        System.out.println("Id del administrador R: " + ticket.getIdAdminR());
